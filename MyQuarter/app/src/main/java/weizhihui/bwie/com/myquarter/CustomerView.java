...
public class CustomerView extends RelativeLayout {
    ...
    public CustomerView(Context context, AttributeSet attrs) {
        ...
        image_show = (ImageView) view.findViewById(R.id.image_show);
        image_jian = (ImageView) view.findViewById(R.id.image_jian);
        image_report = (ImageView) view.findViewById(R.id.image_report);
        image_copy = (ImageView) view.findViewById(R.id.image_copy);
        image_pingbi = (ImageView) view.findViewById(R.id.image_pingbi);
        //默认隐藏
    ...
    public void showMenu() {
        ...
        ObjectAnimator thirdAnimator = ObjectAnimator.ofFloat(image_report
                , "translationX", 0, -35 * 3/2);

        //旋转动画
        ObjectAnimator rotation1 = ObjectAnimator.ofFloat(image_jian, "rotation", 0, 100, 0);
        ObjectAnimator rotation2 = ObjectAnimator.ofFloat(image_report, "rotation", 0, 100, 0);
        ObjectAnimator rotation3 = ObjectAnimator.ofFloat(image_copy, "rotation", 0, 100, 0);
        ObjectAnimator rotation4 = ObjectAnimator.ofFloat(image_pingbi, "rotation", 0, 100, 0);

        //组合动画
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.setDuration(3000);//动画时长
    ...
    public void hideMenu() {
        ...
        ObjectAnimator rotation1 = ObjectAnimator.ofFloat(image_show, "rotation", 0, 100, 0);
        ObjectAnimator rotation2 = ObjectAnimator.ofFloat(image_copy, "rotation", 0, 100, 0);
        ObjectAnimator rotation3 = ObjectAnimator.ofFloat(image_pingbi, "rotation", 0, 100, 0);
        ObjectAnimator rotation4 = ObjectAnimator.ofFloat(image_report, "rotation", 0, 100, 0);
